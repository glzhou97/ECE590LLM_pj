...
class FSAAccuracyTest(absltest.TestCase):
  ...
  def test_evaluate_parameter(self):
    ...
    #print out the standard attention result and the groundtruth
    print("standard_attention_result: ", standard_attention_result)
    print("standard_attention_result: ", standard_attention_result.shape)
    print("unstruct_rfm_attention_result: ", unstruct_rfm_attention_result)
    # #print out the standard attention result and the groundtruth
    # print("standard_attention_result: ", standard_attention_result)
    # print("ortho fast attention: ", ortho_rfm_attention_result)
    # print("error: ", ortho_error)
  ...
  def test_small_example_evaluate_unidirectional(self):
    ...
    ortho_error = jnp.abs(unidirectional_ortho_rfm_attention_result -
                          groundtruth)
    # #print out the unidiagonal attention result and the groundtruth
    # print("unidirectional_unstruct_rfm_attention_result: ", unidirectional_unstruct_rfm_attention_result)
    # print("groundtruth: ", groundtruth)
    # print("error: ", unstruct_error)
    # #print out unidirectional_unstruct_rfm_attention_result and groundtruth
    # print("unidirectional_ortho_rfm_attention_result: ", unidirectional_ortho_rfm_attention_result)
    # print("groundtruth: ", groundtruth)
    # print("error: ", ortho_error)
    self.assertLess(jnp.max(jnp.abs(unstruct_error)), max_error)
...
if __name__ == "__main__":
  FSAAccuracyTest().test_evaluate_parameter()
  absltest.main()
